...
function setupRoutes(app) {
    ...
    app.post('/db', function (req, res, next) {
        ...
        db.addItem(item, function (err, createdItem) {
            /*
             HINT: If an error has occurred during saving
             the item, then the .add method calls
             it's callback with the error as a first parameter.
             This is an indication that something
             has gone wrong and we handle it.
             */
            if (err) {
